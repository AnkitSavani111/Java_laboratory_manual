...
class Pr_11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Oggy", 18, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Bob", 19, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("Joey", 20, 'M');
